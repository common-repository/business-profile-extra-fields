...
function bpefwp_print_facebook_link( $location = false) {
	...
	<a href="<?php echo $bpfwp_str_facebook ; ?>"><?php echo $bpfwp_str_facebook_txt; ?></a>
	</div>
	<?php endif;
    }
function bpefwp_print_instagram_link( $location = false) {
	...
	<a href="<?php echo $bpfwp_str_instagram ; ?>"><?php echo $bpfwp_str_instagram_txt; ?></a>
	</div>
	<?php endif;
    }
function bpefwp_print_twitter_link( $location = false) {
	...
	if ($bpfwp_str_twitter_txt=="") {$bpfwp_str_twitter_txt=__('Follow us on X', BPEFWP_TEXTDOMAIN);}
	?>
	<div class="bpefwp-twitter-link">
	<a href="<?php echo $bpfwp_str_twitter ; ?>"><?php echo $bpfwp_str_twitter_txt; ?></a>
	</div>
	<?php endif;
    }
